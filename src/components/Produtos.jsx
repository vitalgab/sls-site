...
const produtos = [
  {
    id: 'saude',
    icon: (
      <svg style={{ width: 'var(--icone-prod)', height: 'var(--icone-prod)' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
  ...
  return (
    <section id="produtos" style={{ background: 'var(--white)' }}>
      <div className="container">
        ...
        <div className="produtos-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 'var(--gap-m)' }}>
          {produtos.map(p => (
            <div key={p.id} style={{
            ...
            >
              {p.tag && (
                <span style={{
                  ...
                  fontSize: 'var(--fs-nano)', fontWeight: 700,
              ...
              <h3 style={{
                ...
                fontSize: 'var(--fs-h3)', fontWeight: 400,
                color: p.featured ? '#fff' : 'var(--navy)',
                marginBottom: 8,
              }}>
                {p.title}
              ...
              <p style={{
                fontSize: 'var(--fs-xs)', lineHeight: 1.75, flex: 1, marginBottom: 20,
              ...
              <ul style={{ listStyle: 'none', marginBottom: 16, display: 'flex', flexDirection: 'column', gap: 8 }}>
                {p.items.map(item => (
                  <li key={item} style={{
                    ...
                    fontSize: 'var(--fs-xxs)', color: p.featured ? 'rgba(255,255,255,0.85)' : 'var(--gray-800)',
                  }}>
                    <span style={{
        ...
        <div style={{ textAlign: 'center', marginTop: 44 }}>
          <a
            ...
            style={{
              ...
              padding: '15px 40px',
              color: 'var(--navy)', fontWeight: 600, fontSize: 'var(--fs-btn)',
