const perfis = [
  {
    ...
    photoW: 1224, photoH: 1204,
    photoAlt: 'Mulher de óculos e blazer azul-marinho sobre camisa branca, sorrindo',
    icon: (
      <svg style={{ width: 'var(--icone-g)', height: 'var(--icone-g)' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    photoW: 1224, photoH: 1202,
    photoAlt: 'Médico de jaleco branco com estetoscópio no pescoço, barba grisalha e óculos, sorrindo',
    icon: (
      <svg style={{ width: 'var(--icone-g)', height: 'var(--icone-g)' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    photoW: 1224, photoH: 1204,
    photoAlt: 'Homem de óculos, terno cinza e gravata vinho, braços cruzados, sorrindo',
    icon: (
      <svg style={{ width: 'var(--icone-g)', height: 'var(--icone-g)' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    photoW: 1128, photoH: 1109,
    photoAlt: 'Mulher de cabelo longo e camisa branca, olhando para a câmera',
    icon: (
      <svg style={{ width: 'var(--icone-g)', height: 'var(--icone-g)' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  return (
    <section id="para-quem" style={{ background: 'var(--gray-50)' }}>
      <div className="container">
        ...
        <div className="paraquem-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 'var(--gap-g)' }}>
          {perfis.map(p => (
            <div key={p.title} className="paraquem-card" style={{
              ...
              {/* A foto e PNG/WebP transparente: quem pinta o fundo e este
                  ...
                  imagem. */}
              <div style={{ height: 'var(--h-persona)', overflow: 'hidden', position: 'relative', background: 'var(--navy)' }}>
                {/* width/height sao as dimensoes INTRINSECAS do arquivo, e estao
                    aqui pela PROPORCAO: sem elas o navegador nao sabe quanto
                    espaco reservar e a pagina pula quando a foto chega (CLS).
                    Nao mudam o desenho — o CSS abaixo manda 100%/100% e style
              ...
              <div style={{ padding: '0 var(--space-card)', marginTop: -28, position: 'relative', zIndex: 1 }}>
                <div style={{
                  width: 'var(--caixa-icone)', height: 'var(--caixa-icone)', borderRadius: 14,
                  background: 'var(--white)',
              ...
              <div style={{ padding: '14px var(--space-card) var(--space-card-b)' }}>
                <h3 style={{
                  fontFamily: 'var(--font-display)',
                  fontSize: 'var(--fs-h3)', fontWeight: 400, color: 'var(--navy)',
                  marginBottom: 10, lineHeight: 1.25,
                }}>{p.title}</h3>
                <p style={{ color: 'var(--gray-600)', lineHeight: 1.75, fontSize: 'var(--fs-sm)' }}>{p.desc}</p>
              </div>
            </div>
          ))}
        </div>
